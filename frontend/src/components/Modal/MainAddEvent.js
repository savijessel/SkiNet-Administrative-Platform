...
const MainAddEvent = ({
  ...
  const AddEvent = async (e) => {
    ...
    if (eventInfo.reoccuriung !== "Single") {
      ...
      addEndDate = new Date(
        addEndDate.getTime() + addEndDate.getTimezoneOffset() * 60000
      );

      eventInfo.reoccur_num =
        (addEndDate.getTime() - storeStartDate.getTime()) /
        (1000 * 60 * 60 * 24);
      ...
      for (let i = 0; i < eventInfo.reoccur_num; i++) {
        ...
        repeatArticle.start =
          storeStartDate.getFullYear() +
          "-" +
          month +
          "-" +
          storeStartDate.getDate();

        //end
        month = storeEndDate.getMonth() + 1;
        repeatArticle.end =
          storeEndDate.getFullYear() +
          "-" +
          month +
          "-" +
        ...
        //start
        pivotStartDate = new Date(
          storeStartDate.getTime() + 24 * 60 * 60 * 1000
        );
    ...
    <div>
      ...
      >
        <ModalHeader close={closeBtn}>
          Event Start: {EventAddModal ? showDate("start") : ""} <br /> Event
              ...
              <Col md={3}>
                <FormGroup inline>
                  ...
                  <Dropdown
                    ...
                    value={Reoccuriung}
                  >
                    <DropdownToggle caret>{Reoccuriung}</DropdownToggle>
                    <DropdownMenu>
                      <DropdownItem
                        onClick={() => changeReoccuring("Single")}
                        selected
                      >
                        Single
                      </DropdownItem>
                      ...
                      <DropdownItem
                        onClick={() => changeReoccuring("Multiple")}
                      >
                        Multiple
                      </DropdownItem>
                    </DropdownMenu>
            ...
            {Reoccuriung === "Multiple" ? (
              <>
                <div>
                  ...
                  <DatePicker
                    selected={EventAddModal ? showDate("startDate") : ""}
                    onChange={(date) => {
                      setStartDate(date);
                ...
                <div>
                  ...
                  <DatePicker
                    selected={EventAddModal ? showDate("endDate") : ""}
                    onChange={(date) => {
                      setEndDate(date);
