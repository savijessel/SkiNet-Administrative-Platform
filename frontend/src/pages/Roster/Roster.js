            ...
            userAuth.user_type === "Hill Admin" ? (
              <Row>
                ...
                <DeleteBulk
                  ...
                  setBulkEventDeleteModal={setBulkEventDeleteModal}
                  currentShift={currentShift}
                  setUpdater={setUpdater}
                />
              </Row>
        ...
        <div className="ShiftTables">
          <Nav tabs>
            ...
            <NavItem>
              ...
              >
                Unavailable({unavailList.length})
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink
          ...
          <FullCalendar
            ...
            events={
              Updater
                ...
                : totalShifts
            } //Specifies the initial shifts that are displayed
            eventClick={(e) => {
              selectShiftHandler(
                e,
                setCurrentShift,
                ...
                setList,
                setActionLog
              ); //Specifies the handler that is called when an shift is clicked
            ...
            } //Specifies the handler that is called when a date is clicked
